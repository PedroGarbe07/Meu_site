...
document.getElementById("titulo").textContent = "Bem Vindo ao meu site pessoal, " + nome_usuario + "!";

if (idade_usuario <= 22) {
    document.getElementById("cumprimentar").textContent = "Salve " + nome_usuario + ", eu sou o Pedro Garbe!";
}else {
